            ...
            <div className="overflow-hidden rounded-3xl border border-border/40 bg-card/45 p-6 shadow-xl backdrop-blur-xl md:p-8">
              ...
              <div className="mt-8 space-y-6">
                ...
                <div className="block space-y-2 border-t border-border/20 pt-4">
                  ...
                  <div className="flex items-center gap-2 rounded-xl border border-border/50 bg-background/30 px-3 py-2 backdrop-blur-sm">
                    <Filter className="h-4 w-4 text-muted-foreground" />
                    <select
                      value={selectedBudgetFilter}
                      onChange={(e) => setSelectedBudgetFilter(e.target.value)}
                      className="w-full cursor-pointer bg-transparent text-xs font-semibold text-foreground focus-visible:outline-none"
                    >
