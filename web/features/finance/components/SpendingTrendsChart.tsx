...
export default function SpendingTrendsChart({ isLoading, insights }: SpendingTrendsChartProps) {
                ...
                <Stack sx={{ justifyContent: 'space-between' }}>
                    ...
                    >
                        <Typography variant="h4" component="p">
                            {money.format(insights.summary.spent)}
                        </Typography>
                        <Chip
                            size="small"
                            label={`${insights.summary.usage.toFixed(2)}%`}
                            color={getUsageColor(insights.summary?.usage)}
                        />
                    </Stack>
