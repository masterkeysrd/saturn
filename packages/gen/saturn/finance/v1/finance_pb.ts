 ...
 *
 * @generated from message saturn.finance.v1.UpdateExpenseRequest
 */
export type UpdateExpenseRequest = Message<"saturn.finance.v1.UpdateExpenseRequest"> & {
  /**
   ...
   *
   * @generated from field: saturn.finance.v1.Expense expense = 2;
   */
  expense?: Expense;
...
/**
 * Describes the message saturn.finance.v1.UpdateExpenseRequest.
 ...
 *
 * @generated from message saturn.finance.v1.DeleteTransactionRequest
 */
export type DeleteTransactionRequest = Message<"saturn.finance.v1.DeleteTransactionRequest"> & {
  /**
 ...
 * @generated from message saturn.finance.v1.DeleteTransactionRequest
 */
export type DeleteTransactionRequestJson = {
  /**
   * The unique identifier of the transaction to delete.
   *
   * @generated from field: string id = 1;
...
/**
 * Describes the message saturn.finance.v1.DeleteTransactionRequest.
 * Use `create(DeleteTransactionRequestSchema)` to create a new message.
 */
export const DeleteTransactionRequestSchema: GenMessage<DeleteTransactionRequest, {jsonType: DeleteTransactionRequestJson}> = /*@__PURE__*/
...
export const Transaction_BudgetInfoSchema: GenMessage<Transaction_BudgetInfo, {jsonType: Transaction_BudgetInfoJson}> = /*@__PURE__*/
  messageDesc(file_saturn_finance_v1_finance, 23, 0);
...
export const Transaction_TypeSchema: GenEnum<Transaction_Type, Transaction_TypeJson> = /*@__PURE__*/
  enumDesc(file_saturn_finance_v1_finance, 23, 1);
...
export const UpdateSettingRequestSchema: GenMessage<UpdateSettingRequest, {jsonType: UpdateSettingRequestJson}> = /*@__PURE__*/
  messageDesc(file_saturn_finance_v1_finance, 24);
...
export const SettingSchema: GenMessage<Setting, {jsonType: SettingJson}> = /*@__PURE__*/
  messageDesc(file_saturn_finance_v1_finance, 25);
...
export const Setting_StatusSchema: GenEnum<Setting_Status, Setting_StatusJson> = /*@__PURE__*/
  enumDesc(file_saturn_finance_v1_finance, 25, 0);
...
export const Finance: GenService<{
   ...
   *
   * @generated from rpc saturn.finance.v1.Finance.UpdateExpense
   */
  updateExpense: {
    methodKind: "unary";
   ...
   *
   * @generated from rpc saturn.finance.v1.Finance.DeleteTransaction
   */
  deleteTransaction: {
    methodKind: "unary";
